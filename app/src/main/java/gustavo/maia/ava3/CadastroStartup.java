...
public class CadastroStartup extends AppCompatActivity {

    private EditText edit_nome,edit_email_cadastro,edit_senha_cadastro;
    ...
    private void SalvarDadosUsuario(){
        ...
        usarioID = FirebaseAuth.getInstance().getCurrentUser().getUid();

        DocumentReference documentReference = db.collection("Usuários").document(usarioID);
